#' @title Judge the academic potential
#'
...
judge_potential <- function(Curr_acd, predict_acd, pot_lvl1 = 15, pot_lvl2 = 10, abs_lvl1 = 20, abs_lvl2 = 10){
  ...
  judge = case_when(
    ...
    factor(levels = report.iqz::judgment_lvls)
}
